...
function createWidgetPRDV(element) {
  if (element !== null) {
    ...
    a.href = "".concat(prdv_mna_hostname, "/form?fromReferrer=").concat(fromReferrer, "&centreId=").concat(valueCentreId, "&trainingId=").concat(valueTrainingId, "&siteName=").concat(valueSiteName, "&candidatFirstname=").concat(valueCandidatFirstname, "&candidatLastname=").concat(valueCandidatLastname);
